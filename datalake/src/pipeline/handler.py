...
def handler(event: dict, context: Any) -> dict:
    ...
    from src.transform import compute
    from src.ingestion import jquants as fetch
    from src.ingestion import yahoo_finance as fetch_external
    from src.ingestion import news as fetch_news
    from src.graph import kuzu as graph
    from src.notification import notifier
    from src.transform import sector_rotation
    from src.signals import generator as signals
    from src.transform import statistics
    from src.pipeline import storage
    from src.transform import td_sequential
