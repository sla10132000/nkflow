...
class TestTradingDaysHelper:
    def test_returns_sorted_dates(self, conn):
        _seed(conn)
        from src.batch.backtest import _trading_days
    ...
    def test_nth_after_existing_date(self, conn):
        _seed(conn)
        from src.batch.backtest import _trading_days, _nth_trading_day_after
        days = _trading_days(conn)
...
class TestSimulateTrades:
    def test_creates_trade_rows(self, conn, db_path):
        _seed(conn)
        from src.batch.backtest import simulate_trades
...
class TestCalcMetrics:
    ...
    def test_win_rate(self, conn):
        from src.batch.backtest import calc_metrics
    ...
    def test_max_drawdown(self, conn):
        from src.batch.backtest import calc_metrics, _calc_max_drawdown
    ...
    def test_sharpe_ratio_none_for_single_trade(self, conn):
        from src.batch.backtest import _calc_sharpe
